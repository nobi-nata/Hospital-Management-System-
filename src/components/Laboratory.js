    ...
    <div className="container my-3">
      <div>
        ...
        <p id="p-lab">
          ...
          The laboratory is directed by a board certified Clinical and Anatomic
          Pathologist. Technologists and technicians perform a variety of
        ...
        <p id="p-lab">
          ...
          Quickheal and Rushford Clinic patients. Patients may receive separate
          bills for lab work and physician services.
        </p>
      </div>
      <div>
        ...
        <p id="p-lab">
          ...
          directly to the laboratory from the patient care area via a pneumatic
          tube system, whereas smaller hospitals will have specimens picked up
          and dropped off by laboratory couriers. Once at the laboratory,
          specimens are received, sorted, registered, and then marked as
          “received” in the Laboratory Information System (LIS) before being
        ...
        <ul>
          ...
          <li id="list">
            ...
            types of specimens to be collected. For example, hematology testing
            usually requires whole blood specimens collected in EDTA tubes (for
            CBC testing) or sodium citrate tubes (for coagulation studies),
            whereas chemistry test usually require blood serum or heparinized
            plasma. Other specimens include urine, stool, sputum, tissue, and
            other body fluids.
          </li>
          <li id="list">
            ...
            cancelled as “quantity not sufficient” or “QNS” and the patient will
            need to provide a new sample.
          </li>
          <li id="list">
            ...
            ensure specimen integrity. For instance, many tests allow specimens
            to be processed and stored for longer periods of time if they are
      ...
      <div>
        ...
        <p id="p-lab">
          ...
          pathology branch and a forensic pathology branch, while smaller
          laboratories will send specimens out to bigger labs for this type of
          testing.
        </p>
        <img
        ...
        <p id="p-lab">
          ...
          processed, affixed to slides, and stained or sliced and embedded into
          wax blocks for microscopic analysis. By studying the structure and
      ...
      <div>
        ...
        <p id="p-lab">
          ...
          detect clotting problems and monitor drug therapies. Urinalysis, sperm
        ...
        <p id="p-lab">
          ...
          patient. Various specimens are first cultured onto media using
          different techniques. The goal of culturing is to isolate pure
          colonies of bacteria, mold, or fungi that can then be identified using
          methods such as mass spectrometry or PCR. Once identified, antibiotic
          susceptibility testing is usually performed to determine the best
          course of antibiotic therapy for the patient. Other testing in the
        ...
        <p id="p-lab">
          ...
          transfusion. The blood bank keeps an inventory of red blood cells,
          plasma, platelets, and cryoprecipitate available for routine blood
          transfusions, surgeries, and traumas. When a patient needs blood, the
          blood bank is responsible for determining the patient’s blood type,
          testing for and identifying any antibodies present, and then providing
          crossmatch compatible blood components.
        </p>
      </div>
      <div>
        ...
        <p id="p-lab">
          ...
          analyzing a patient’s karyotype, cytogenetic technologists and
        ...
        <p id="p-lab">
          ...
          disease or make them more susceptible to cancers. It can also be used
